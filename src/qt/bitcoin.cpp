...
// TODO: implement URI support on the Mac.
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "florijncoin:"))
        {
    ...
    app.setOrganizationName("florijncoin");
    app.setOrganizationDomain("we-have-no-domain-yet.nex");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("florijncoin-qt-testnet");
    else
        app.setApplicationName("florijncoin-qt");
